...
func NewEvalManager(cb EvalCallback) fed.TaskManager {
	var round int = 0
	var prevAccuracy float64 = -1

	return &fed.SimpleTaskManager{
		GetPayloadFunc: func (client string) (fed.Payload, error) {
